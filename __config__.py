...
#WSJ0_MIX_2_8K_PATH = '/dsi/gannot-lab/datasets/whamr/wav8k/min/tt/mix_both_reverb'
...
WHAM_ROOT_PATH = '/mnt/data/wham'
WHAMR_ROOT_PATH = '/dsi/gannot-lab/datasets/whamr'
...
API_KEY = '50kAJzsUG9fPf0S5avFAnMSNC'
